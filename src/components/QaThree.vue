  ...
  <div>
    <div class="w-50 bg-secondary m-auto pt-1 pb-1">
      ...
      <div class="bg-dark m-2">     <!--  mydata[i].options[i].a -->
        ...
        <button  :disabled="myboolean" @click="currect" id="ans3"  class="right text-end p-2 w-100">{{question.opb}}</button>
...
import {useStore} from "vuex";
  ...
  let question= computed(()=> {
    return ownstore.getters.questionThree;
  })
function currect() {
     document.querySelector("#ans3").style.background="Chartreuse";
